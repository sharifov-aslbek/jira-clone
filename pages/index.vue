...
<template>
    <section class="flex items-center justify-between h-[100vh] pt-[10vh] gap-4 bg-gradient-to-t from-white to-blue-500 dark:from-black dark:to-blue-600">
        <div class="pl-20 flex flex-col space-y-3">
            <h1 class="text-5xl">Mova fast stay, aligned, and build better - together</h1>
            <p class="text-lg opacity-80">The 1# Sofware lorem ipsum used by agile teams</p>
            <NuxtLink to="auth">
                    <UButton color="blue">Try it free</UButton>
                </NuxtLink>
        </div>

        <img class="w-[1230px]" src="/public/hero.webp" alt="Not found">
    </section>
            ...
            <template #item="{item}">
                <div class='flex justify-between items-center gap-6 mt-8'>
                    <div class="w-[40%]">
                        ...
                        <div class="py-4 mt-12 rounded-r-full flex flex-col space-y-2 bg-gradient-to-r from-white to-blue-500 dark:from-black dark:to-blue-800">
                            <Icon name="bxs:quote-alt-left" class="text-7xl" />
                            <p class="text-2xl pl-2">{{ item.credentials.text }}</p>
                    ...
                    <img :src="item.image" class="w-[60%]" alt="">
                </div>
            </template>
        </UTabs>
     </section>
     ...
     <section>
        ...
        <div class="flex items-center justify-between max-w-xl mx-auto mt-4">
            <div class="w-16 h-16 bg-blue-500 dark:bg-blue-800 rounded-full flex items-center justify-center">
                <Icon class="text-4xl" name="iconamoon:3d-bold" />
            </div>
            
            <div class="flex-1 h-2 bg-gradient-to-r from-blue-500 dark:from-blue-700 to-gray-500 dark:to-gray-800">
